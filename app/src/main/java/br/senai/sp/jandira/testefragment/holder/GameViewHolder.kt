...
import kotlinx.android.synthetic.main.holder_recycler_view_layout.view.*

class GameViewHolder (itemView: View) : RecyclerView.ViewHolder(itemView) {

    val  textGameName = itemView.findViewById<TextView>(R.id.text_view_game_name)
    val textViewGameDescription = itemView.findViewById<TextView>(R.id.text_view_game_description)
    ...
    fun bind(game: Game){
        ...
        textViewGameDescription.text = game.gameDescription
